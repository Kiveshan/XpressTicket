...
const Invoice = () => {
  ...
  const formatEventDates = () => {
    ...
    try {
      ...
      const startDate = eventData.startDate || (eventData.event && eventData.event.startDate) || ""
      const endDate = eventData.endDate || (eventData.event && eventData.event.endDate) || ""
...
Quantity: ${ticket.quantity || 1}`,
      ...
      try {
        ...
        totalAmount = Number.parseFloat(priceString.replace(/[^0-9.]/g, "")) || 0
      }
