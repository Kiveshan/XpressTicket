...
const nav= useNavigate();
  ...
  <div className="conference-info">
      ...
      Ticket will be sent via Email pending approval from organizer. Please check your inbox. If you have not recieved it    contact organizer Here{' '}
        <a href="#" className="download-link" onClick={handleDownload}>
        contact organizer Here
        </a>
      </p>

      <button className="next-button" onClick={()=> nav('/ticketslist')}>
        View Tickets
      </button>
