            ...
            <div className="compact-card compact-event-card">
              <div className="compact-event-header">
                <div className="compact-event-title">
                  ...
                  {eventDetails.shortName && <p className="compact-event-subtitle">{eventDetails.shortName}</p>}
                </div>
              </div>
                        ...
                        <tr key={index}>
                          ...
                          <td>
                            <div className="compact-attendee-cell">
                              <div className="compact-attendee-name">{pkg.title} {pkg.name}</div>
                              {pkg.gender && <div className="compact-attendee-gender">{pkg.gender}</div>}
                            </div>
                          </td>
                          <td>
                            <div className="compact-contact-cell">
                              {pkg.email && <div className="compact-contact-email"><FaEnvelope /> {pkg.email}</div>}
                              {pkg.phone && <div className="compact-contact-phone"><FaPhone /> {pkg.phone}</div>}
                            </div>
                          </td>
                          <td>
                            <div className="compact-package-cell">
