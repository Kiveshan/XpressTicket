  ...
  return (
    <div className="modern-dashboard-container">
      ...
      <div className="modern-back-button">
        <button className="modern-back-btn" onClick={() => nav('/organiser-dash')}>
                ...
                <tr key={index}>
                  ...
                  <td>
                    <span className={`modern-badge ${
                      payment.status === 'Verified' ? 'modern-badge-success' : 
                      payment.status === 'Pending' ? 'modern-badge-warning' : 'modern-badge-info'
                    }`}>
                      {payment.status}
                    </span>
                  </td>
